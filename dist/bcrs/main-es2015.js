...
let SecurityQuestionsComponent = class SecurityQuestionsComponent {
    ...
    delete(questionId, questionText) {
        const dialogRef = this.dialog.open(_shared_question_delete_dialog_question_delete_dialog_component__WEBPACK_IMPORTED_MODULE_4__["QuestionDeleteDialogComponent"], {
            data: {
