...
/* harmony import */ var _shared_question_delete_dialog_question_delete_dialog_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../../shared/question-delete-dialog/question-delete-dialog.component */ "./src/app/shared/question-delete-dialog/question-delete-dialog.component.ts");
...
var SecurityQuestionsComponent = /** @class */ (function () {
    ...
    SecurityQuestionsComponent.prototype.delete = function (questionId, questionText) {
        var _this = this;
        var dialogRef = this.dialog.open(_shared_question_delete_dialog_question_delete_dialog_component__WEBPACK_IMPORTED_MODULE_4__["QuestionDeleteDialogComponent"], {
            data: {
    ...
    SecurityQuestionsComponent.prototype.edit = function (questionId) {
        ...
        var _this = this;
        this.securityService.getQuestionById(questionId).toPromise().then(function (data) {
            _this.question = data;
